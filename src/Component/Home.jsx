    ...
    <>
      ...
      <div className="relative mt-2" id="Home">
        <div className="flex justify-center items-center dark:bg-slate-900 dark:text-white">
          <div className="custom h-screen absolute left-0 top-7 z-[-1] w-full overflow-hidden line-height-0 bg-blue-500 bg-gradient-to-b from-white dark:from-12% to-red-400 to-90% dark:bg-gradient-to-b dark:from-slate-900 dark:from-12% dark:to-red-200 dark:to-90%">
            <svg
              data-name="Layer 1"
